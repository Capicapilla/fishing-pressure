const lucio = {
    ...
    ceboRecomendado: ["Vinilos articulados", "Spinnerbaits", "Jerkbaits", "Peces artificiales grandes", "Cucharillas ondulantes"],
    colorAconsejado: ["Verde", "Plateado", "Blanco", "Rojo"],
